...
public class ANALYSIS_AND_ADVICE_1 extends AppCompatActivity implements View.OnClickListener, BaseUrl {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        new MyIntent(ANALYSIS_AND_ADVICE_1.this, HomeActivity.class, R.anim.enter2, R.anim.exit2);
    }
    ...
    void datepicker() {
        ...
        final DatePickerDialog dpd = new DatePickerDialog(ANALYSIS_AND_ADVICE_1.this, R.style.DialogTheme,
    ...
    public void onClick(View v) {
        ...
        if (v == next) {
            ...
            Intent intent = new Intent(ANALYSIS_AND_ADVICE_1.this, ANALYSIS_AND_ADVICE_2.class);
            startActivity(intent);
            finish();
        }
        if (v == home_L) {
            new MyIntent(ANALYSIS_AND_ADVICE_1.this, HomeActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == profile_L) {
            new MyIntent(ANALYSIS_AND_ADVICE_1.this, User_Profile.class, R.anim.enter, R.anim.exit);
        }
        if (v == log_L) {
            new MyIntent(ANALYSIS_AND_ADVICE_1.this, LogActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == plans_L) {
            new MyIntent(ANALYSIS_AND_ADVICE_1.this, PlansActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == more_L) {
            new MyIntent(ANALYSIS_AND_ADVICE_1.this, MoreActivity.class, R.anim.enter, R.anim.exit);
        }
    }
