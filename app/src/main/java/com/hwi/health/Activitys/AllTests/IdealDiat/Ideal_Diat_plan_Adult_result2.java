...
public class Ideal_Diat_plan_Adult_result2 extends AppCompatActivity implements View.OnClickListener, BaseUrl {
    ...
    int number;
    ProductController_For_All controller = new ProductController_For_All(Ideal_Diat_plan_Adult_result2.this);
    ProgressDialog pd;
    ...
    void default_custom_diet_plan() throws JSONException

    {

        String check=CalorieCalculator.getCustomPlanAdult(getApplicationContext());
...
//                    datalist.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd, Optimized_Milk_curd, Health_Risks_Milk_curd, R.drawable.milk));
        ...
        else {datalist.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd, Optimized_Milk_curd, Health_Risks_Milk_curd, R.drawable.milk));}
...
//                    datalist.add(new customized_model("Dals/meat/fish/day", "1/2 cup cooked dal OR 2 pieces of boneless meat each of matchbox size", Indian_Diet_Dals_meat, Optimized_Dals_meat, Health_Risks_Dals_meat, R.drawable.dals));
        ...
        //datalist.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd2, Optimized_Milk_curd2, Health_Risks_Milk_curd2, R.drawable.milk));
        if (!checkAddition(Indian_Diet_Milk_curd2,Optimized_Milk_curd2,Health_Risks_Milk_curd2)){}
        else {Lunch_list.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd2, Optimized_Milk_curd2, Health_Risks_Milk_curd2, R.drawable.milk));}
...
//                    datalist.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd3, Optimized_Milk_curd3, Health_Risks_Milk_curd3, R.drawable.milk));
        ...
        if (!checkAddition(Indian_Diet_Fruits2,Optimized_Fruits2,Health_Risks_Fruits2)){}
        else {snack_list.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd3, Optimized_Milk_curd3, Health_Risks_Milk_curd3, R.drawable.milk));}
...
//                    datalist.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd4, Optimized_Milk_curd4, Health_Risks_Milk_curd4, R.drawable.milk));
        ...
        else {Dinner_list.add(new customized_model("Milk/curd", "11 cup=200 ml", Indian_Diet_Milk_curd4, Optimized_Milk_curd4, Health_Risks_Milk_curd4, R.drawable.milk));}
...
//                    datalist.add(new customized_model("Fruits", "1 medium size fruit or 1/2 cup cut fruit OR 1/2 cup fruit juice", Indian_Diet_Fruits6, Optimized_Fruits6, Health_Risks_Fruits6, R.drawable.fruit));
        ...
        //Toast.makeText(Ideal_Diat_plan_Adult_result2.this, message, Toast.LENGTH_SHORT).show();
        Intent in = new Intent(Ideal_Diat_plan_Adult_result2.this, Customised_Diet_Plan_result.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(Ideal_Diat_plan_Adult_result2.this, R.layout.spinner,R.id.text_item, spin_list);
        spin.setAdapter(adapter);

        aListModel = (ArrayList<RecycleModel>) getIntent().getSerializableExtra("data_2");
        ...
        spin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (exercise.equals("Basic Diet")) {
                    ...
                    RecyclerViewAdapter2 rv = new RecyclerViewAdapter2(cleanList(aListModel,value), Ideal_Diat_plan_Adult_result2.this, value, Ideal_Diat_plan_Adult_result2.this);
                    GridLayoutManager lLayout = new GridLayoutManager(Ideal_Diat_plan_Adult_result2.this, 2);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        new MyIntent(Ideal_Diat_plan_Adult_result2.this, PlansActivity.class, R.anim.enter2, R.anim.exit2);
    }
    ...
    void find_id() {
        ...
        hint = (RelativeLayout) findViewById(R.id.dialog_lay);
        yes = (Button) findViewById(R.id.yes);
        no = (Button) findViewById(R.id.no);
        get_cot = (Button) findViewById(R.id.get_cot);

        SharedPreferences preferences = getSharedPreferences("IsSee", MODE_PRIVATE);
        String see = preferences.getString("seen", "no");
        if (see.equals("yes")) {
    ...
    public void onClick(View v) {
        if (v == home_L) {
            new MyIntent(Ideal_Diat_plan_Adult_result2.this, HomeActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == profile_L) {
            new MyIntent(Ideal_Diat_plan_Adult_result2.this, User_Profile.class, R.anim.enter, R.anim.exit);
        }
        if (v == log_L) {
            new MyIntent(Ideal_Diat_plan_Adult_result2.this, LogActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == plans_L) {
            new MyIntent(Ideal_Diat_plan_Adult_result2.this, PlansActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == more_L) {
            new MyIntent(Ideal_Diat_plan_Adult_result2.this, MoreActivity.class, R.anim.enter, R.anim.exit);
        }
        if (v == yes) {
            SharedPreferences preferences = getSharedPreferences("IsSee",MODE_PRIVATE);
            ...
            if (cust_key.equals("1")) {
                ...
                SharedPreferences getPreferences = getSharedPreferences("IsSee",MODE_PRIVATE);
                new MyIntent(Ideal_Diat_plan_Adult_result2.this, Major_Meals_Page1.class, R.anim.enter, R.anim.exit);
            }
        }
        if (v == get_cot) {
            SharedPreferences preferences = getSharedPreferences("IsSee",MODE_PRIVATE);
            String see = preferences.getString("seen", "no");
            if(see.equals("yes")==true)
            {
                try {
                    default_custom_diet_plan();
                    return;
    ...
    void AlertDialog() {
        dialog = new Dialog(Ideal_Diat_plan_Adult_result2.this, R.style.CustomDialog);
        ...
        text_nmae.setText("We have created a detailed customized diet plan for you. Do you want to see it? ");
    ...
    class Task extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(Ideal_Diat_plan_Adult_result2.this);
